...
{
    func transform(fromKey key: String, value: Any, isViewCollapsed: Bool = true) -> PreferenceViewType
    {
        switch value {
        ...
        case is Date: return PreferenceViewType.date(key: key, viewModel: PreferenceDateViewModel(title: key, value: value as! Date, isViewCollapsed: isViewCollapsed))

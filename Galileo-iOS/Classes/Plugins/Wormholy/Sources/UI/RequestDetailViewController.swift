...
class RequestDetailViewController: WHBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "TextTableViewCell", bundle: Galileo.bundle), forCellReuseIdentifier: "TextTableViewCell")
        tableView.register(UINib(nibName: "ActionableTableViewCell", bundle: Galileo.bundle), forCellReuseIdentifier: "ActionableTableViewCell")
        tableView.register(UINib(nibName: "RequestTitleSectionView", bundle: Galileo.bundle), forHeaderFooterViewReuseIdentifier: "RequestTitleSectionView")
    }

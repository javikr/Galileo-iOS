...
{    
    ...
    {
        let defaultIcon = UIImage(named: "103-doubt", in: Bundle(for: GalileoMainViewController.self), compatibleWith: nil)
        ...
        super.init(nibName: nil, bundle: Bundle(for: GalileoMainViewController.self))

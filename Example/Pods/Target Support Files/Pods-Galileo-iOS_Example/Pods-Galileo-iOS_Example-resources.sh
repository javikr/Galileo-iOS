...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/../../Galileo-iOS/Classes/Plugins/Preferences Plugin/View/Cell/PreferenceBoolTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../Galileo-iOS/Classes/Plugins/Preferences Plugin/View/Cell/PreferenceDateTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../Galileo-iOS/Classes/Plugins/Preferences Plugin/View/Cell/PreferenceIntegerTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../Galileo-iOS/Classes/Plugins/Preferences Plugin/View/Cell/PreferenceTextTableViewCell.xib"
  install_resource "${PODS_ROOT}/../../Galileo-iOS/Classes/Plugins/Preferences Plugin/View/PreferencesGalileoViewController.xib"
